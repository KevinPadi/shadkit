    ...
    <section className="py-32 px-2 md:px-4">
      <div className="container mx-auto">
        <div className="flex flex-col items-center gap-12">
          ...
          <div className="flex flex-col gap-6 items-center justify-center lg:flex-row w-full mx-auto">
            <div className="flex flex-col items-center justify-center lg:items-start lg:justify-start gap-3 w-full lg:w-auto lg:min-h-[400px]">
              <h3 className="text-xl lg:text-3xl">Have any question?</h3>
              <p className="text-sm text-muted-foreground text-center lg:text-start text-balance">
                Contact our sales team for custom plans and enterprise
                solutions.
              </p>
            ...
            <div className="flex flex-col gap-4 items-center justify-center md:flex-row w-full mx-auto">
              {data.map((item, index) => (
                <Card key={index} className="w-full sm:max-w-xs min-h-[400px]">
