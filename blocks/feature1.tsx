    ...
    <section className="py-32 px-2 md:px-4">
      <div className="container mx-auto">
        <div className="flex flex-col items-center gap-8">
          ...
          <ItemGroup className="flex sm:flex-row items-center gap-4 w-fit mx-auto">
            {data.map((item, index) => (
              <Item
                key={index}
                variant="outline"
                className="p-0 max-w-md rounded-2xl"
              >
                <ItemHeader className="p-4 flex flex-col items-start justify-center gap-4">
                ...
                <ItemContent className="">
                  <Image
                    ...
                    width={128}
                    height={128}
                    className="aspect-video w-full rounded-b-2xl object-cover"
                  />
                </ItemContent>
              </Item>
            ))}
